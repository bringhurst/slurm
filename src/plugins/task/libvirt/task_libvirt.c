/*****************************************************************************\
 *  task_libvirt.c - Library for containment using libvirt subsystems
 *****************************************************************************
 ...
 */
const char plugin_name[]        = "Tasks containment using libvirt";
const char plugin_type[]        = "task/libvirt";
